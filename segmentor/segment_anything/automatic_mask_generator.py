...
class SamAutomaticMaskGenerator:
    ...
    def _generate_masks(
        ...
        for crop_box, layer_idx in zip(crop_boxes, layer_idxs):
            crop_data = self._process_crop(image, crop_box, layer_idx, self.orig_size)
            data.cat(crop_data)
    ...
    def _process_crop(
        ...
        self.predictor.set_image(image, self.orig_size)
    ...
    def _process_batch(
        ...
        keep_mask = ~is_box_near_crop_edge(data["boxes"], crop_box, [0, 0, orig_w, orig_h], atol=10)
