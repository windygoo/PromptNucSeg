...
#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke321_b/best.pth --eval --config pannuke321_b.py

#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke123_l/best.pth --eval --config pannuke123_l.py
#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke213_l/best.pth --eval --config pannuke213_l.py
#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke321_l/best.pth --eval --config pannuke321_l.py

#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke123_h/best.pth --eval --config pannuke123_h.py
#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke213_h/best.pth --eval --config pannuke213_h.py
#torchrun --nproc_per_node=4 main.py --resume checkpoint/pannuke321_h/best.pth --eval --config pannuke321_h.py
